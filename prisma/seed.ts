// prisma/seed.ts
// Datos iniciales para DERCAS v1.0.0
...
async function main() {
  console.log("🌱 Iniciando seed de DERCAS...");
  ...
  const admin = await prisma.usuario.upsert({
    where: { email: "admin@dercas.com" },
    update: {},
    create: {
      nombre: "Administrador DERCAS",
      email: "admin@dercas.com",
  ...
  const tesorero = await prisma.usuario.upsert({
    where: { email: "tesorero@dercas.com" },
    update: {},
    create: {
      nombre: "Carlos Mendoza",
      email: "tesorero@dercas.com",
  ...
  const encargado = await prisma.usuario.upsert({
    where: { email: "encargado@dercas.com" },
    update: {},
    create: {
      nombre: "Luis García",
      email: "encargado@dercas.com",
  ...
  const usuarioFamilia = await prisma.usuario.upsert({
    where: { email: "familia.perez@dercas.com" },
    update: {},
    create: {
      nombre: "Juan Pérez",
      email: "familia.perez@dercas.com",
  ...
  console.log("   Admin:     admin@dercas.com     / Admin123!");
  console.log("   Tesorero:  tesorero@dercas.com  / Tesorero123!");
  console.log("   Encargado: encargado@dercas.com / Encargado123!");
  console.log("   Familia:   familia.perez@dercas.com / Familia123!");
}
